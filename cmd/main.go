...
Application endpoint.
	...
	Commands:
		generate-configs:    generate yaml format template for manual filling
		generate-manifests:  generate k8s manifests from template
		download-templates:  download manifests templates to local
*/
